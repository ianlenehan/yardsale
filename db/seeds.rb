...
u1 = User.create :name_first => "Ian", :name_last => "Lenehan", :email => "ianlenehan@me.com", :password => "balmain", :admin => true
u2 = User.create :name_first => "Templeton", :name_last => "Peck", :email => "temp@me.com", :password => "balmain"
